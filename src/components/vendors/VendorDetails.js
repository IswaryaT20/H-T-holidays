...
const CustomerDetails = (props) => {
  ...
  return (
    ...
    >
      <Row
        className=""
        style={{ height: "", paddingBottom: 50, marginTop: "75px" }}
      >
        {selectedCustomer && (
          <>
            <Col
      ...
      <>
        ...
        >
          ...
          <Modal.Footer>
            <Button type="submit" variant="secondary" onClick={showBankDetails}>
              Close
            </Button>

            <Button type="submit" variant="primary" onClick={saveBankDetails}>
              Save
            </Button>
          </Modal.Footer>
        </Modal>
