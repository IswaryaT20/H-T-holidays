...
const Newproduct = () => {
  ...
  //Dummy table headers
  const tableValue = ["Invoice No", "Invoice Date", "Due Date", "Net Date", "Customer Name", "Total Amount", "Due Amount", "Payment", "Action"];
    ...
    <Container fluid className="mt-2">
      ...
      <Row style={{ marginTop: '2%' }}>
        <Col className='col-8' style={{ paddingLeft: '2%' }}>
          <div className='d-flex'>
            <Link to="/NewInvoice" style={{textDecoration:"none", color:"white"}}><Button style={{backgroundColor:"#1d1d5e", borderColor:"#1d1d5e", width:"80px"}}>New +</Button></Link>
            <InputGroup
