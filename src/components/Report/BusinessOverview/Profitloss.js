...
function Report() {
    ...
    return (
        <div>
            ...
            <Link to="/Report" className="mt-1"> <GoChevronLeft style={{ fontSize: '25px' ,marginTop:75}}/></Link>

                <p style={{ fontSize: '14px', fontWeight: 'bold' }} className="mt-2" >Profit & Loss Statement</p>
                {/* <Button variant='primary' onClick={handleRunReport}>Back</Button> */}
            </div>
            ...
            <div className="ms-5 mt-4 me-5" style={{ overflowY: 'auto'}}>
